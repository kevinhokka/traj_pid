...
class Astar
{
    private:
        ...
        std::priority_queue<NodePtr, std::vector<NodePtr>, NodeComparator> open_set_;//open set
    ...
    public:
        ...
        void setParam(std::string package_path);
        void init();
        void reset();
